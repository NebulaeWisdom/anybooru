...
`Gelbooru`、`Gelbooru02`、`Shuushuu`、`Sakuria`、`AnimePictures`、`Cosine`、`Nhentai`、`ArtStation`），选择哪个类由调用者决定。
...
[cosine-api.md](cosine-api.md)、[nhentai-api.md](nhentai-api.md)、[artstation-api.md](artstation-api.md)）。
...
Serika、e621ng、Zerochan、Gelbooru、Gelbooru02、Shuushuu、Sakuria、Anime-Pictures、Cosine、nhentai 与 ArtStation 把查询整块放进 `*_query` 字典再展开（nhentai 另把页码放在 `pages`）；
